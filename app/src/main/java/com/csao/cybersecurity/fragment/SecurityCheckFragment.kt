...
class SecurityCheckFragment : Fragment() {
    ...
    fun alert_box(msg1:String,msg2:String,msg3:String,msg4:String,msg5:String,score:Int){
        if(msg1==""||msg2==""||msg3==""||msg4==""||msg5==""){
            Toast.makeText(context,"Favor dar respuesta a todas las preguntas",Toast.LENGTH_LONG).show()
...
//---------------------------------------------------------------------
    ...
    AlertDialog.Builder(context)
        .setTitle(Html.fromHtml("<font color='#2a405e'>Calificación : $score</font>"))
